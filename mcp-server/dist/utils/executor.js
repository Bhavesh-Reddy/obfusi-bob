 ...
 */
export async function executeWithTimeout(command, timeoutMs = 30000) {
 ...
 * @returns Execution result
 */
export async function executeLLVMPass(irPath, passName, outputPath) {
 ...
 * @returns Execution result
 */
export async function verifyIR(irPath) {
 ...
 */
export async function getLLVMVersion() {
    try {
